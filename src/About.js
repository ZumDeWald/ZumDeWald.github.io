      ...
      <div className="about-article-area">
        ...
        <ul className="about-list">
          <li className="about-list-item">
            <p className="about-article-text">My goal on every shoot is to capture true expressions. The sweet little smiles, the tears, the quirky expressions and even the somber faces <em>which are my favorite!</em> </p>
            ...
            <p className="about-article-text">
            I will direct some posing, but my goal is to capture personality and natural body language.</p></li>

          <li className="about-list-item">
            <h3 className="about-sub-heading">Newborn Specific</h3>
            <p className="about-article-text">For my Newborn Session clients, you will receive step by step instructions on how to prepare your baby for their session.  You will also receive a questionaire so I can better prepare for your unique stylized session. </p>
            <p className="about-article-text">
            ...
            <p className="about-article-text">
            Plan on the session length being atleast 2 hours. </p> </li>
            ...
            <li className="about-list-item">
              ...
              <p className="about-article-text">The remainder of the session fee minus the deposit is due at the time of the session by either cash or pay-pal. </p>
              <p className="about-article-text">
